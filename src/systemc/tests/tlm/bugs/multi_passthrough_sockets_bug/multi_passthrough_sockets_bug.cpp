...
public:
    ...
    explicit initiator_module(sc_core::sc_module_name module_name)
        : sc_core::sc_module(module_name), initiator_socket("initiator_socket")
    {
        SC_THREAD(process);
    }
...
public:
    ...
    explicit target_module(sc_core::sc_module_name module_name)
        : sc_core::sc_module(module_name), target_socket("target_socket"), target_optional("target_optional")
    {
...
public:
    ...
    introspector_module(sc_core::sc_module_name module_name) : sc_core::sc_module(module_name)
    {
        SC_THREAD(process);
    }
