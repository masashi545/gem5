...
void test_smaller(const sc_lv<4> &lv_one, const sc_lv<4> &lv_two)
{
    cout << "*** smaller ***" << endl;
    {
        sc_int<8> a(lv_one);
...
void test_equal(const sc_lv<4> &lv_one, const sc_lv<4> &lv_two)
{
    cout << "*** equal ***" << endl;
    {
        sc_int<4> a(lv_one);
...
void test_larger(const sc_lv<4> &lv_one, const sc_lv<4> &lv_two)
{
    cout << "*** larger ***" << endl;
    {
        sc_int<2> a(lv_one);
