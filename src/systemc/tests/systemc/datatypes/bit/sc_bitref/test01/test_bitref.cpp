...
int sc_main(int, char *[])
{
    ...
    // bitrefs to concrefs
    {
        /* auto */ sc_concref<sc_concref<sc_subref<sc_bv_base>, sc_subref<sc_bv_base>>, sc_bitref<sc_bv_base>>
            bv_range = (bv.range(7, 6), bv.range(5, 1), bv[1]);
        /* auto */ sc_concref_r<sc_concref_r<sc_subref<sc_bv_base>, sc_subref<sc_lv_base>>, sc_bv_base>
