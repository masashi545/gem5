...
void test(sc_dt::sc_fxnum_bitref a)
{
#if (defined(__GNUC__) && (__GNUC__ >= 3)) || (defined(_MSC_VER) && (_MSC_VER >= 1300))
    std::stringstream ss;
#else
...
void test(sc_dt::sc_fxnum_fast_bitref a)
{
#if (defined(__GNUC__) && (__GNUC__ >= 3)) || (defined(_MSC_VER) && (_MSC_VER >= 1300))
    std::stringstream ss;
#else
...
void test(sc_dt::sc_fxnum_subref a)
{
#if (defined(__GNUC__) && (__GNUC__ >= 3)) || (defined(_MSC_VER) && (_MSC_VER >= 1300))
    std::stringstream ss;
#else
...
void test(sc_dt::sc_fxnum_fast_subref a)
{
#if (defined(__GNUC__) && (__GNUC__ >= 3)) || (defined(_MSC_VER) && (_MSC_VER >= 1300))
    std::stringstream ss;
#else
