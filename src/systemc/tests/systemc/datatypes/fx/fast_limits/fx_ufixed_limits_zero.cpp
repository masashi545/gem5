...
void test_fx_ufixed_limits_zero(ostream &out)
{
    ...
    sc_ufixed<8, 5> zero_min("-0");
    SHOW(zero_min);
    sc_ufixed<8, 5> zero_plus("+0");
    SHOW(zero_plus);
    sc_ufixed<8, 5> zero(0);
    SHOW(zero);

    sc_ufixed<8, 5> long_max(LONG_MAX);
    SHOW(long_max);
    sc_ufixed<8, 5> long_min(LONG_MIN);
    SHOW(long_min);
    sc_ufixed<8, 5> int_max(INT_MAX);
    SHOW(int_max);
    sc_ufixed<8, 5> int_min(INT_MIN);
    SHOW(int_min);
    sc_ufixed<8, 5> uint_max(UINT_MAX);
    SHOW(uint_max);
    sc_ufixed<8, 5> ulong_max(ULONG_MAX);
    SHOW(ulong_max);

    sc_ufixed<8, 5> double_min(DBL_MIN);
    SHOW(double_min);
    sc_ufixed<8, 5> double_max(DBL_MAX);
    SHOW(double_max);
    sc_ufixed<8, 5> float_min(FLT_MIN);
    SHOW(float_min);
    sc_ufixed<8, 5> float_max(FLT_MAX);
    SHOW(float_max);
