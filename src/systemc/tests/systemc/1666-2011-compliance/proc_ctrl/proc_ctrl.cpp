...
SC_MODULE(Top)
{
    ...
    void target()
    {
        ...
        case 4:
            ...
            break;
        case 8:
            sc_assert(sc_time_stamp() == sc_time(95, SC_NS));
            f8 = 1;
            break;
        case 12:
        ...
        for (;;)
        {
            try
            {
                ...
                case 1:
                    ...
                    break;
                case 5:
                    sc_assert(sc_time_stamp() == sc_time(75, SC_NS));
                    f5 = 1;
                    break;
                case 6:
                    sc_assert(sc_time_stamp() == sc_time(80, SC_NS));
                    f6 = 1;
                    break;
                case 7:
                ...
                case 18:
                    ...
                    break;
                case 24:
                    sc_assert(sc_time_stamp() == sc_time(255, SC_NS));
                    f15 = 1;
                    break;
                case 25:
            ...
            catch (const sc_unwind_exception &e)
            {
                ...
                case 14:
                    ...
                    break;
                case 29:
                    sc_assert(sc_time_stamp() == sc_time(295, SC_NS));
                    f23 = 1;
                    break;
                default:
                    sc_assert(false);
