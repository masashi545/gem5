...
{
    SC_CTOR(Top)
        : caught_throw_it(0), caught_reset(0), caught_kill(0)

          ,
          target_suspend_1_called(false), target_suspend_2_called(false), target_suspend_3_called(false), target_suspend_4_called(false), target_suspend_5_called(false)

          ,
          target_disable_1_called(false), target_disable_2_called(false), target_disable_2_called_again(false), target_disable_3_called(false), target_disable_4_called(false), target_disable_5_called(false)

          ,
          target_sync_reset_1_called(false), target_sync_reset_2_called(false), target_sync_reset_3_called(false), target_sync_reset_4_called(false)

          ,
          reset_1_count(0), reset_2_count(0), reset_3_count(0), reset_4_count(0)
    {
        SC_THREAD(ctrl);
