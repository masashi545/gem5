...
struct Top : sc_module
{
    ...
    void target()
    {
        ...
        case 30:
            ...
            break;
        case 32:
            sc_assert(sc_time_stamp() == sc_time(530, SC_NS));
            f21 = 1;
            break;
        case 33:
            sc_assert(sc_time_stamp() == sc_time(540, SC_NS));
            f22 = 1;
            break;
        case 35:
            sc_assert(sc_time_stamp() == sc_time(560, SC_NS));
            f23 = 1;
            break;
        default:
            sc_assert(false);
        ...
        for (;;)
        {
            ...
            case 4:
                ...
                break;
            case 5:
                sc_assert(sc_time_stamp() == sc_time(45, SC_NS));
                f4 = 1;
                break;
            case 7:
                sc_assert(sc_time_stamp() == sc_time(55, SC_NS));
                f6 = 1;
                break;
            case 11:
            ...
            case 18:
                ...
                break;
            case 19:
                sc_assert(sc_time_stamp() == sc_time(300, SC_NS));
                f13 = 1;
                break;
            case 21:
                sc_assert(sc_time_stamp() == sc_time(315, SC_NS));
                f14 = 1;
                break;
            case 25:
                ...
                break;
            case 39:
                sc_assert(sc_time_stamp() == sc_time(600, SC_NS));
                f24 = 1;
                break;
            default:
                sc_assert(false);
