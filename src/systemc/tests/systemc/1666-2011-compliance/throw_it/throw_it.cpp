...
struct Top : sc_module
{
    ...
    void target1() // Target for throw_it from calling()
    {
        ...
        case 0:
            ...
            break;
        case 12:
            sc_assert(sc_time_stamp() == sc_time(405, SC_NS));
            f13 = 1;
            break;
        case 17:
            sc_assert(sc_time_stamp() == sc_time(510, SC_NS));
            f19 = 1;
            break;
        default:
            sc_assert(false);
        ...
        for (;;)
        {
            try
            {
                ...
                {
                case 1:
                    sc_assert(sc_time_stamp() == sc_time(5, SC_NS));
                    f3 = 1;
                    break;
                case 7:
            ...
            catch (const std::exception &ex)
            {
                ...
                case 6:
                    ...
                    break;
                case 9:
                    sc_assert(sc_time_stamp() == sc_time(310, SC_NS));
                    f10 = 1;
                    break;
                case 10:
                    sc_assert(sc_time_stamp() == sc_time(320, SC_NS));
                    f11 = 1;
                    break;
                case 12:
                    sc_assert(sc_is_unwinding());
                ...
                case 13:
                    sc_assert(!sc_is_unwinding());
                    sc_assert(sc_time_stamp() == sc_time(410, SC_NS));
                    f14 = 1;
                    break;
                case 14:
                    sc_assert(sc_time_stamp() == sc_time(420, SC_NS));
                    f15 = 1;
                    break;
                case 16:
                    sc_assert(sc_time_stamp() == sc_time(500, SC_NS));
                    f16 = 1;
                    break;
                case 17:
                    sc_assert(sc_is_unwinding());
    ...
    void target5() // Target for throw_it from calling() + async_reset_signal
    {
        ...
        {
        case 19:
            sc_assert(sc_time_stamp() == sc_time(610, SC_NS));
            f20 = 1;
            break;
        case 21:
            sc_assert(sc_time_stamp() == sc_time(630, SC_NS));
            f23 = 1;
            break;
        case 23:
            sc_assert(sc_time_stamp() == sc_time(650, SC_NS));
            f26 = 1;
            break;
        default:
            sc_assert(false);
        ...
        for (;;)
        {
            try
            {
                ...
                {
                case 20:
                    sc_assert(sc_time_stamp() == sc_time(620, SC_NS));
                    f21 = 1;
                    break;
                case 26:
                    sc_assert(sc_time_stamp() == sc_time(700, SC_NS));
                    f28 = 1;
                    break;
                default:
                    sc_assert(false);
            ...
            catch (const std::exception &ex)
            {
                ...
                case 22:
                    sc_assert(!sc_is_unwinding());
                    sc_assert(sc_time_stamp() == sc_time(640, SC_NS));
                    f24 = 1;
                    break;
                case 23:
                    sc_assert(sc_is_unwinding());
                ...
                case 24:
                    sc_assert(!sc_is_unwinding());
                    sc_assert(sc_time_stamp() == sc_time(660, SC_NS));
                    f27 = 1;
                    break;
                default:
                    sc_assert(false);
